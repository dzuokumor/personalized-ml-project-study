      ...
      <div className="bg-white rounded-2xl max-w-lg w-full shadow-xl">
        <div className="p-6 border-b border-slate-200">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-bold text-slate-900">Publish to GitHub</h2>
            <button
              onClick={onclose}
        ...
        <div className="p-6">
          {success ? (
            <div className="text-center py-4">
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2">Repository Created!</h3>
              <p className="text-slate-500 mb-4">Your project has been published to GitHub.</p>
              <a
                href={success}
                target="_blank"
            ...
            <div className="text-center py-4">
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2">Connect GitHub</h3>
              <p className="text-slate-500 mb-4">Link your GitHub account to publish projects as repositories.</p>
              <button
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 p-3 bg-emerald-50 rounded-lg">
                ...
                <span className="text-sm text-emerald-700">GitHub connected</span>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                />
                <label htmlFor="private" className="text-sm text-slate-600">Make repository private</label>
              </div>
