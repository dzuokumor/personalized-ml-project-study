...
export default function course() {
  ...
  return (
    <div>
      ...
      <div className="glass-card rounded-xl p-4 sm:p-8 mb-6 sm:mb-8">
        <div className="flex items-start gap-3 sm:gap-4 mb-4 sm:mb-6">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2">{coursedata.title}</h1>
            <p className="text-sm sm:text-base text-slate-600">{coursedata.description}</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <span className="text-sm text-slate-600 whitespace-nowrap">{overallprogress}%</span>
        </div>
      </div>
      ...
      {showpublish && (
        <Publishmodal course={coursedata} onclose={() => setshowpublish(false)} />
      )}
    </div>
  )
}
